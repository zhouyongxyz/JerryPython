...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.contentTabWiget.setTabText(self.contentTabWiget.indexOf(self.tab_1), _translate("MainWindow", "Client 1"))
        self.contentTabWiget.setTabText(self.contentTabWiget.indexOf(self.tab_2), _translate("MainWindow", "Client 2"))
